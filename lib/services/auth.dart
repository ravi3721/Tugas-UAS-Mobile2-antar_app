  ...
  Future registerWithEmailAndPassword(String email, String password) async {
    try {
      ...
      await UserDatabase(uid: user!.uid).updateUser(
          email.split('@')[0],
          email,
          'https://firebasestorage.googleapis.com/v0/b/antar_app-flutter.appspot.com/o/images%2Fdefault_user_photo.png?alt=media&token=0f46f1f2-e3c8-486b-9cb5-381f7dab155e',
      ...
      await TokoDatabase(uid: user.uid).updateToko(
          ...
          position.latitude,
          position.longitude,
          'https://firebasestorage.googleapis.com/v0/b/antar_app-flutter.appspot.com/o/images%2Fdefault_toko_photo.png?alt=media&token=725972f0-2808-4050-9f09-6adf98bf4962',
