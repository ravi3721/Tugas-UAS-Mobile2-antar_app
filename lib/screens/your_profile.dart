...
import 'package:antar_app/models/antar_app_user.dart';
import 'package:antar_app/screens/menu_toko.dart';
import 'package:antar_app/services/databases/user_database.dart';
import 'package:flutter/material.dart';
import 'package:antar_app/global_styles.dart';
import 'package:antar_app/components/back_appbar.dart';
...
class _YourProfileState extends State<YourProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamProvider<antar_appUser>.value(
      initialData: antar_appUser(),
...
class ProfileBuilder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final antar_appuser = Provider.of<antar_appUser>(context);
    // log('logging user in your_profile');
    // log("${antar_appuser.length > 0 ? antar_appuser.first.email : ''}");
    // log('${antar_appuser.email}');
    // return Container();
    return Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage("${antar_appuser.foto}"),
                        fit: BoxFit.cover),
              ...
              Positioned(
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      if (image != null) {
                        UserDatabase(uid: antar_appuser.id).updateUserFoto(
                            antar_appuser.fotoRef ?? '', File(image.path));
                      }
                    },
                    child: Container(
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  // UserDatabase(uid: antar_appuser.id).deleteUser();
                  showDialog(
                      context: context,
                      barrierDismissible: false,
