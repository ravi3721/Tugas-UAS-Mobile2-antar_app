...
import 'package:antar_app/models/toko.dart';
import 'package:antar_app/screens/detail_toko.dart';
import 'package:antar_app/screens/item_detail.dart';
import 'package:antar_app/screens/maps/networking.dart';
import 'package:antar_app/services/databases/produk_database.dart';
import 'package:antar_app/services/databases/rating_database.dart';
import 'package:antar_app/services/databases/toko_database.dart';
import 'package:antar_app/services/toko_distance.dart';
import 'package:flutter/material.dart';
import 'package:antar_app/global_styles.dart';
import 'package:antar_app/components/navbar.dart';
import 'package:antar_app/services/database.dart';
import 'package:provider/provider.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:antar_app/models/produk.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            preferredSize: Size.fromHeight(100), child: antar_appAppBar()),
        body: Container(
...
class antar_appAppBar extends StatefulWidget {
  const antar_appAppBar({Key? key}) : super(key: key);

  @override
  State<antar_appAppBar> createState() => _antar_appAppBarState();
}

class _antar_appAppBarState extends State<antar_appAppBar> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
